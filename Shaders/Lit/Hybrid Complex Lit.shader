// @IllusionRP: Fork of Complex Lit with hybrid lighting features
...
Shader "Universal Render Pipeline/Hybrid Complex Lit"
{
    Properties
    {
        ...
        [ToggleOff] _OrderIndependent("Order Independent", Float) = 0.0
        [ToggleOff] _ScreenSpaceReflections("Screen Space Reflections", Float) = 1.0
        [ToggleOff] _ScreenSpaceAmbientOcclusion("Screen Space Ambient Occlusion", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.kurisu.illusion-render-pipelines/Shaders/Lit/HybridLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Shader Stages
            #pragma vertex LitPassVertex
            #pragma fragment LitOITPassFragment

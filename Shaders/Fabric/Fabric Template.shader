Shader /*ase_name*/ "Hidden/Universal/Fabric" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			Option:Workflow:Specular,Metallic:Metallic
				...
				Specular:SetDefine:ForwardGBuffer:pragma shader_feature_local_fragment _SPECULAR_SETUP
				...
				Metallic:RemoveDefine:ForwardGBuffer:pragma shader_feature_local_fragment _SPECULAR_SETUP
			...
			Option:Translucency:false,true:true
				true:SetOption:Forward Only,1
				true:ExcludePass:GBuffer
				false,disable:IncludePass:GBuffer
			...
			Option:Receive Occlusion:false,true:false
				true:SetDefine:_TRANSPARENT_WRITE_DEPTH 1
				false:RemoveDefine:_TRANSPARENT_WRITE_DEPTH 1
				true:IncludePass:PostDepthNormals
				true:ExcludePass:PostDepthOnly
				false,disable:IncludePass:PostDepthOnly
				false,disable:ExcludePass:PostDepthNormals
			Option:GPU Instancing:false,true:true
				...
				true:SetDefine:PostDepthNormals:pragma multi_compile_instancing
				...
				false:RemoveDefine:PostDepthNormals:pragma multi_compile_instancing
			...
			Option:LOD CrossFade:false,true:true
				...
				true:SetDefine:PostDepthNormals:pragma multi_compile_fragment _ LOD_FADE_CROSSFADE
				...
				false:RemoveDefine:PostDepthNormals:pragma multi_compile_fragment _ LOD_FADE_CROSSFADE
			...
			Option:DOTS Instancing:false,true:false
				...
				true:SetDefine:PostDepthNormals:pragma multi_compile _ DOTS_INSTANCING_ON
				...
				false:RemoveDefine:PostDepthNormals:pragma multi_compile _ DOTS_INSTANCING_ON
		...
		*/
		...
		Pass
		{
						...
						/*ase_frag_input*/ ) : SV_Target
			{
				...
				float3 SheenNormal = /*ase_frag_out:Sheen Normal;Float3;21;-1;_SheenNormal*/float3(0, 0, 1)/*end*/;
		...
		{
			/*ase_hide_pass*/
			Name "PostDepthNormals"
			Tags 
			{ 
				"LightMode" = "PostDepthNormals" 
		    }
